...
while bot.step(timestep)  !=  -1:
    ...
    if keypressed  ==  317:                # down key is pressed
        ...
        wrist_3_pos -= 0.01
    elif keypressed  ==  53:               # 4 key is pressed
        finger_pos += 0.01
    elif keypressed  ==  54:               # 4 key is pressed
       finger_pos -= 0.01
        
    elif keypressed  ==  55:               # 4 key is pressed
        lower_knuckle_pos += 0.01
    elif keypressed  ==  56:               # 4 key is pressed
        lower_knuckle_pos -= 0.01
    elif keypressed  ==  57:               # 4 key is pressed
       middle_knuckle_pos += 0.01
    elif keypressed  ==  48:               # 4 key is pressed
        middle_knuckle_pos += 0.01
    elif keypressed  ==  45:               # 4 key is pressed
        upper_knuckle_pos -= 0.01
    elif keypressed  ==  61:               # 4 key is pressed
        upper_knuckle_pos += 0.01
        
        
    
    move_bot(shoulder_lift_pos, shoulder_pan_pos, elbow_pos, 
             wrist_1_pos, wrist_2_pos, wrist_3_pos,finger_pos,0.3,0.3,upper_knuckle_pos)